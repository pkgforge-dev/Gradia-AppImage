...
* [Latest Stable Release](https://github.com/pkgforge-dev/Gradia-AppImage/releases/latest)
...
* [AM](https://github.com/ivan-hc/AM) `am -i gradia` or `appman -i gradia`

* [dbin](https://github.com/xplshn/dbin) `dbin install gradia.appimage`

* [soar](https://github.com/pkgforge/soar) `soar install gradia`
